    ...
    <div className="md:hidden">
      ...
      >
        <div className="flex flex-col items-center justify-center h-full space-y-8 text-2xl">
          ...
          <NavLink to="/plans" onClick={onToggle}>Plans</NavLink>
          {user && <NavLink to="/dashboard" onClick={onToggle}>Dashboard</NavLink>}
          {user && <NavLink to="/referral" onClick={onToggle}>Referral</NavLink>}
          {user ? (
            <>
              <NavLink to="/profile" onClick={onToggle}>Profile</NavLink>
              <button 
